...
import axios from 'axios';
 class OrganisatorDetails extends React.Component {
   constructor(){
       super()
       this.state={
        username:'',
  ...
  componentDidMount() {
    ...
    getOne(){
        console.log('id',localStorage.getItem('idorganisator'));
        const element = fetch("http://localhost:3100/organisator/" + localStorage.getItem('idorganisator'))
      ...
      handleSubmit(){
        ...
        const url= "http://localhost:3100/organisator/"+localStorage.getItem('idorganisator')
        axios.patch(url, {
          ...
          window.location.href="/admin/Organisators/"
          }
        })
   ...
   ActivateAccount(){
       if(this.state.activated=="compte activé"){alert('Compte déja activé')}
        ...
        const url= "http://localhost:3100/organisator/AdminActivateAccount/"+localStorage.getItem('idorganisator')
        axios.patch(url,{}, {
          headers: {
            'Authorization': `Bearer ${token}` 
          }
                    ...
                    <div className="card-profile-image">
                      <a href="#pablo" onClick={(e) => e.preventDefault()}>
                        <img
                          ...
                          src={`http://localhost:3100/organisator/getprofilepicture/${this.state.image}`}
...
export default OrganisatorDetails;